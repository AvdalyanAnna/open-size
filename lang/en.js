export default {
    ...
    home: {
        block1: {
            titleBold: 'Minimize <br>  the negative impact on the environment ',
        ...
        block4: {
            title: '<span class="font-bold">OpenSize</span> <br> Product Ecosystem',
        },
        block5: {
        ...
        block8: {
            title: '<b>OpenSize mobile platform <br> is the path to the world of e-fittings and online shopping </b>',
